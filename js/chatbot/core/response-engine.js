...
🏙 ${cityA.toUpperCase()}
📈 ROI: ${marketA.avgROI}
🏨 Occupazione: ${marketA.occupancy}
⚠️ Rischio: ${marketA.risk}

VS

🏙 ${cityB.toUpperCase()}
📈 ROI: ${marketB.avgROI}
🏨 Occupazione: ${marketB.occupancy}
⚠️ Rischio: ${marketB.risk}`;
