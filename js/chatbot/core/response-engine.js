...
if(!hasAnalysis){
    ...
    response.textIT = `📈 Il ROI (Return On Investment) misura quanto rende il capitale investito.

L'AI di RendimentoBB lo calcola considerando:
...
💡 Dopo una simulazione riceverai il tuo ROI personalizzato confrontato con il benchmark della città.`;

    response.textEN = `📈 ROI (Return On Investment) measures the return generated by your invested capital.

RendimentoBB AI calculates it using:
...
💡 After running a simulation you'll receive your personalized ROI together with the city benchmark.`;
...
// ===========================================
  ...
  if(!hasAnalysis){
    ...
    response.textIT = `💰 Il Cashflow rappresenta il denaro realmente generato dall'investimento dopo aver sottratto tutte le spese.
...
💡 Dopo una simulazione riceverai il cashflow reale del tuo investimento.`;

    response.textEN = `💰 Cashflow is the real money generated after all operating costs.
...
💡 After a simulation you'll receive your real projected cashflow.`;
...
📈 The simulation shows potentially stable financial sustainability.`;
  ...
  // ===========================================
    ...
    response.textIT = `⚠️ Il Risk Score misura il livello di rischio dell'investimento.
...
💡 Dopo una simulazione riceverai un Risk Score personalizzato da 0 a 100.`;

    response.textEN = `⚠️ The Risk Score measures the overall investment risk.
...
💡 After running a simulation you'll receive your personalized Risk Score from 0 to 100.`;
...
// ===========================================
  ...
  if(!hasAnalysis){
    ...
    response.textIT = `🧠 L'AI Strategy Advisor valuta un investimento combinando:

• ROI
• Cashflow
• Risk Score
• Occupazione
• Benchmark della città
• Leva finanziaria

💡 Dopo una simulazione riceverai una strategia personalizzata con il verdetto AI sull'investimento.`;

    response.textEN = `🧠 The AI Strategy Advisor evaluates an investment by combining:
...
💡 After running a simulation you'll receive a personalized AI investment strategy and recommendation.`;
