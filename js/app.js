...
function generatePDF() {
  ...
  pdf.text(
    isIT ? "Executive Investment Report" : "Executive Investment Report",
    20,
    y
  );
  ...
  pdf.setFont(undefined, "bold");
  pdf.text(
    isIT ? "1. Executive Overview" : "1. Executive Overview",
    20,
    y
  );
  ...
  pdf.text(`ROI: ${d.baseROI.toFixed(2)}%`, 20, y); y+=7;
  pdf.text(
    `Break-even: ${d.breakEvenYears.toFixed(1)} ${isIT ? "anni" : "years"}`,
    20,
    y
  ); y+=7;
  pdf.text(`Stress ROI: ${d.pessimisticROI.toFixed(2)}%`, 20, y); y+=7;
  pdf.text(`Risk Index: ${d.riskScore}/100`, 20, y); y+=10;
  ...
  pdf.setFont(undefined, "bold");
  pdf.text(
    isIT ? "2. Financial Outlook" : "2. Financial Outlook",
    20,
    y
  );
  ...
  // ===============================
  // SECTION 3 – STRATEGIC COMMENT
  // ===============================

  pdf.setFont(undefined, "bold");
  pdf.text(
    isIT ? "3. Strategic Assessment" : "3. Strategic Assessment",
    20,
    y
  );
  ...
  pdf.save(
    isIT ? "RendimentoBB_Executive_Report_IT.pdf"
