  ...
  <div style="font-family:Inter,Arial;background:#0f172a;padding:40px">
    ...
    <div style="max-width:680px;margin:auto;background:#ffffff;border-radius:22px;padding:40px">
      ...
      <h2 style="text-align:center;color:#0f172a">
        🔥 ${t(lang,"Lead ad alta conversione","High conversion lead")}
      </h2>

      <p style="text-align:center;color:#64748b;margin-bottom:30px">
        ${t(lang,
          "Questo utente ha effettuato una simulazione reale ed è pronto ad agire",
          "This user completed a real simulation and is ready to act"
        )}
      </p>

      <!-- ROI -->
      <div style="text-align:center;margin:30px 0">
        <div style="font-size:54px;font-weight:800;color:#10b981">
          ${roi}%
        </div>
      ...
      <div style="margin-top:20px;background:#ecfeff;padding:16px;border-radius:12px;color:#0e7490">
        📊 ${t(lang,
          "Lead generato da simulazione reale con dati finanziari",
          "Lead generated from real financial simulation"
        )}
      </div>
      ...
      <div style="text-align:center;margin:35px 0">
        ...
        ">
        🚀 ${t(lang,"Contatta subito","Contact now")}
        </a>
      </div>
      ...
      <div style="text-align:center;color:#94a3b8;font-size:12px">
        RendimentoBB – ${t(lang,
          "Lead qualificato generato dal simulatore",
          "Qualified lead generated by simulator"
        )}
      </div>
